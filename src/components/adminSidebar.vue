  ...
  <div class="admin-sidebar">
    ...
    <nav class="nav-container">
      <ul class="nav">
        ...
        <li class="nav-item">
          <router-link to="/admin/shift" class="nav-link">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
