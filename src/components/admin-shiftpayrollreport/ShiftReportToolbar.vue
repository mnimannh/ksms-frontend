<template>
  <div class="toolbar no-print">
    <div class="breadcrumb">
      ...
      <span class="bc-current">Shift &amp; Payroll Report</span>
    </div>
    ...
    <div class="toolbar-right">
      ...
      <div class="filter-group">
        ...
        <select :value="staffFilter" @change="$emit('update:staffFilter', $event.target.value)" class="filter-select">
...
<script>
export default {
  name: 'ShiftReportToolbar',
  emits: ['update:selectedMonth', 'update:selectedYear', 'update:staffFilter', 'generate', 'print'],
  props: {
    selectedMonth: { type: Number,  required: true },
    selectedYear:  { type: Number,  required: true },
    staffFilter:   { type: [String, Number], default: '' },
