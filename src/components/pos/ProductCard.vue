    ...
    <div class="card-body">
      ...
      <div class="card-footer">
        <div class="stock-indicator" v-if="product.quantity > 0">
          <span
            class="stock-dot"
            :style="product.quantity > 5 ? 'background:#22c55e' : 'background:#f59e0b'"
          />
...
.out-overlay span {
  ...
  color: #f5f4f0; letter-spacing: .07em;
...
.add-btn {
  ...
  padding: 7px 14px;
  border-radius: 99px;
  box-shadow: 0 4px 14px rgba(26,26,24,.3);
  letter-spacing: .02em;
}
...
.price {
  ...
  color: #1a1a18; letter-spacing: -.02em;
}
</style>